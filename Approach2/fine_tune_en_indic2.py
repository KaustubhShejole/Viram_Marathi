...
def main(argv=None):
    ...
    parser.add_argument("--dataset", type=str, default="thenlpresearcher/iitb_en_indic_marathi_orig_punct_tokenized")
    ...
    training_args = Seq2SeqTrainingArguments(
        output_dir=f"{model_name}-en-indic-iitb-only-punct-finetuned-{args.source_lang}-to-{args.target_lang}",
        eval_strategy="steps",
        save_strategy="steps",
